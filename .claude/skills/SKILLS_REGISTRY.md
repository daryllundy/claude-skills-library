...
- **Description**: Ansible playbooks, roles, inventory management, and configuration automation for Linux/Unix infrastructure.
...
- **Category**: Design
- **Description**: Software system architecture, design patterns, and architectural decision-making for backend, distributed, and cloud-native systems.
...
#### 4. azure-specialist
- **Category**: Infrastructure (Cloud)
- **Description**: Azure cloud services, infrastructure, ARM templates, Bicep, and Azure best practices.
...
- **Description**: CI/CD pipeline design and configuration for GitHub Actions, GitLab CI, Jenkins, CircleCI, and Azure DevOps.
...
- **Category**: Quality
- **Description**: Automated code review covering quality, security, performance, and best practices across any language.
...
- **Category**: Business
- **Description**: Regulatory compliance implementation for GDPR, HIPAA, SOC 2, PCI-DSS, and audit trail design.
...
- **Description**: Machine learning pipelines, data analysis, statistical modeling, and data visualization in Python.
...
- **Description**: Database schema design, query optimization, indexing strategy, and migration writing for SQL and NoSQL databases.
...
- **Description**: Systematic bug detection, root cause analysis, and error resolution across languages and systems.
...
- **Category**: Operations
- **Description**: Dependency management, version conflict resolution, security patch updates, and supply chain hygiene across npm, pip, Maven, Cargo, and Go modules.
...
- **Description**: Docker containerization, Dockerfile writing and optimization, multi-stage builds, and Docker Compose configuration for development and production.
...
- **Category**: Productivity
- **Description**: Technical documentation writing including README files, API docs, architecture docs, runbooks, and code comments.
...
- **Category**: Development
- **Description**: Frontend development in React, Vue, Angular, and vanilla JavaScript/TypeScript including UI components, state management, and responsive design.
...
#### 18. gcp-specialist
- **Category**: Infrastructure (Cloud)
- **Description**: Google Cloud Platform infrastructure, services, and architecture using gcloud CLI, Deployment Manager, and Terraform.
...
#### 19. git-specialist
- **Category**: Operations
- **Description**: Git workflows, branching strategies, repository management, and conflict resolution.
...
- **Category**: Infrastructure (Platform)
- **Description**: Kubernetes manifest writing, Helm chart development, cluster configuration, auto-scaling, and cloud-native deployment patterns.
...
- **Category**: Development
- **Description**: Internationalization (i18n) and localization (l10n) implementation for web and mobile applications.
...
- **Category**: Operations
- **Description**: Database migrations, framework version upgrades, and data transformation workflows.
...
- **Category**: Quality
- **Description**: Performance analysis, profiling, and optimization for backend services, databases, and frontend applications.
...
- **Category**: Quality
- **Description**: Code refactoring, technical debt reduction, and code modernization without changing external behavior.
...
- **Category**: Productivity
- **Description**: Project scaffolding, boilerplate generation, and new project setup for various languages and frameworks.
...
- **Category**: Quality
- **Description**: Security auditing, vulnerability identification, secure coding practices, and secrets management.
...
- **Category**: Infrastructure (IaC)
- **Description**: Terraform configuration writing, module development, state management, and multi-cloud infrastructure provisioning.
...
#### 34. test-specialist
- **Category**: Quality
- **Description**: Test suite writing, coverage improvement, and testing strategy for unit, integration, and end-to-end tests.
...
- **Category**: Development
- **Description**: Input validation, business rule implementation, and data integrity enforcement in application code.
...
- **Category**: Design
- **Description**: Modern, accessible, and conversion-optimized web design direction, UX guidance, and design system development.
...
- **Category**: Automation
- **Description**: Zapier workflow automation design, Zap configuration, and SaaS integration planning across 6000+ apps.
