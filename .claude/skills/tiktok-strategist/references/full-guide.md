...
Use the tiktok-strategist skill when you need to:
- Launch a new app and develop a TikTok marketing strategy
- Create viral content ideas for an existing app
- Identify and partner with TikTok influencers
- Optimize app features to be more TikTok-friendly
- Plan comprehensive TikTok campaigns
- Analyze TikTok trends and apply them to app marketing

### Example Scenarios

**Launching a New App:**
- *User*: "We're launching our phone anxiety app next week. How should we approach TikTok?"
- *Strategy*: Create comprehensive TikTok marketing strategy leveraging platform's viral potential and young user base for app launches.

**Creating Viral Content:**
- *User*: "Our meditation app needs more downloads. What kind of TikTok content should we make?"
- *Strategy*: Develop viral TikTok content ideas that showcase the app in trending formats that fit platform culture.

**Influencer Partnerships:**
- *User*: "Should we work with TikTok creators to promote our app?"
- *Strategy*: Identify the right creators and collaboration strategies to provide authentic reach to target audiences.

**TikTok-Native Features:**
- *User*: "How can we make our app more TikTok-friendly?"
- *Strategy*: Identify features and moments in the app that users would want to share on TikTok to drive organic growth through user-generated content.
